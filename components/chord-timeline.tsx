        ...
        {chords.map((chord, i) => {
          ...
          return (
            <button
              ...
              onClick={() => openChordEditor(i)}
              className={`relative aspect-square md:aspect-auto md:w-[88px] md:h-[88px] flex flex-col items-center justify-center rounded-xl border-2 transition-all active:scale-95 bg-slate-900 group
                ${borderClass}
                ${isActivePlay 
                  ? 'border-pink-500 bg-pink-500/10 shadow-[0_0_15px_rgba(236,72,153,0.4)] md:scale-105' 
